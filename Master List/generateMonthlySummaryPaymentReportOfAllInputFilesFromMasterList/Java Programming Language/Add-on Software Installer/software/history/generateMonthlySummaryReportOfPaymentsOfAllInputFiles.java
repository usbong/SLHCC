...
'   java generateMonthlySummaryReportOfPaymentsOfAllInputFiles input_201801.txt
' 
...
'   java generateMonthlySummaryReportOfPaymentsOfAllInputFiles input*
' 
...
'   java generateMonthlySummaryReportOfPaymentsOfAllInputFiles *"2018"*.txt
'
...
'   javac -cp .;org.apache.commons.text.jar generateMonthlySummaryReportOfPaymentsOfAllInputFiles.java
'
...
'   java -cp .;org.apache.commons.text.jar generateMonthlySummaryReportOfPaymentsOfAllInputFiles *.txt
'
...
public class generateMonthlySummaryReportOfPaymentsOfAllInputFiles {	
	private static boolean isInDebugMode = true; //edited by Mike, 20190131
	private static boolean isNetPFComputed = true; //added by Mike, 20190131
	private static final int INPUT_NON_MASTER_LIST_OFFSET = 0; //if not using Master List, value is 1; edited by Mike, 20190208
...
/*	
	...
	private static final int INPUT_NON_MASTER_LIST_OFFSET = 0; //if not using Master List, value is 1 
*/	
...
*/
	...
	{			
		...
		if (isNetPFComputed) {
			writer = new PrintWriter("output/MonthlySummaryReportOfPaymentsOutput.txt", "UTF-8");			
		}
		else {
			writer = new PrintWriter("output/MonthlySummaryReportOutput.txt", "UTF-8");			
		}
...
*/							
		...
		//These output instructions are used to generate the Monthly Summary Report, without the HMO/NON-HMO payments
/*		
