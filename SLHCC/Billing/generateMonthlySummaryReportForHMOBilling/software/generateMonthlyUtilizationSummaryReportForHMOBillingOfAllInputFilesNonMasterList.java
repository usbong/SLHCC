...
//		medicalDoctorContainer = new HashMap<String, double[]>();
		...
		if (isOutputMultipleTxtFilesPerHMO) {
			...
			treatmentTransactionsWriter = new PrintWriter("output/utilization/treatmentOutput.txt", "UTF-8"); //added by Mike, 20190305
		}
		else {
			consultationTransactionsWriter = new PrintWriter("output/utilization/consultationOutput.txt", "UTF-8");
				...
				if ((inputColumns[INPUT_CLASS_COLUMN].contains("HMO")) ||
					...
					if (isOutputMultipleTxtFilesPerHMO) {
						...
						if (!hmoPrintWriterContainer.containsKey(hmoName)) {
							hmoPrintWriterContainer.put(hmoName, new PrintWriter("output/utilization/"+hmoName+".txt","UTF-8"));
						}
					}
...
/*						
						...
						medicalDoctorPrintWriterContainer.put(OUTPUT_HMO_BILLING_UTILIZATION_SUMMARY_MEDICAL_DOCTOR_NAME_PT_VALUE, new PrintWriter("output/utilization/"+
				...
				if ((inputColumns[INPUT_CLASS_COLUMN+INPUT_CONSULTATION_OFFSET].contains("HMO")) ||
					...
					//added by Mike, 20190305
						...
						if (!medicalDoctorPrintWriterContainer.containsKey(medicalDoctorName)) {
							medicalDoctorPrintWriterContainer.put(medicalDoctorName, new PrintWriter("output/utilization/"+
