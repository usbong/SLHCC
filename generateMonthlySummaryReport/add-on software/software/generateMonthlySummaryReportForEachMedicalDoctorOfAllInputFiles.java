...
'
' LINUX: 
'   javac -cp .:org.apache.commons.text.jar generateMonthlySummaryReportForEachMedicalDoctorOfAllInputFiles.java
'
...
'
' LINUX: 
'   java -cp .:org.apache.commons.text.jar generateMonthlySummaryReportForEachMedicalDoctorOfAllInputFiles ./input/consultation/*.txt
'
...
//TO-DO: -delete: excess computer instructions

public class generateMonthlySummaryReportForEachMedicalDoctorOfAllInputFiles {	
	...
	//added by Mike, 20220615
	private static final int MAX_TRANSACTIONS_PER_MEDICAL_DOCTOR = 300; //TO-DO: -add: auto-update size based on input Consultation file's transactions row count
...
*/
	...
	//added by Mike, 20220615	
	private static HashMap<String, String[][]> medicalDoctorTransactionsContainer; 
	private static int iMedicalDoctorTransactionsRowCount;
	
	private static HashMap<String, Integer> medicalDoctorTransactionsCountContainer; 
...
//		medicalDoctorContainer = new HashMap<String, double[]>();
		...
		//added by Mike, 20220615				
		medicalDoctorTransactionsContainer = new HashMap<String,String[][]>();
		iMedicalDoctorTransactionsRowCount=0;

		medicalDoctorTransactionsCountContainer = new HashMap<String,Integer>();
...
//		knownDiagnosedCasesContainer = new HashMap<String, String>(); //added by Mike, 20190412
		...
		//added by Mike, 2022061
		//TO-DO: -delete: excess computer instructions		

//removed by Mike, 20220615					
/*		
		//added by Mike, 20190412
...
//		System.out.println("args[0]: " + args[0]);
		...
		*/
		...
		if (!isConsultationInputFileEmpty) {
			...
			//added by Mike, 20220615
			processWriteOutputFileConsultationMedicalDoctorReport();			
		}
		else {
...
//			System.out.println("CONSULTATION inputMedicalDoctor: "+inputMedicalDoctor);
			...
			//added by Mike, 20220615
			if (!medicalDoctorTransactionsContainer.containsKey(inputMedicalDoctor)) {	

				medicalDoctorTransactionsCountContainer.put(inputMedicalDoctor, 0);
						
				medicalDoctorTransactionsContainer.put(inputMedicalDoctor, new String[MAX_TRANSACTIONS_PER_MEDICAL_DOCTOR][OUTPUT_TOTAL_COLUMNS]); //, 0);
				medicalDoctorTransactionsContainer.get(inputMedicalDoctor)[0]=inputColumns;		

//System.out.println("inputColumns[0]: "+inputColumns[0]);


System.out.println("inputMedicalDoctor: "+inputMedicalDoctor);

System.out.println("medicalDoctorTransactionsContainer.get(inputMedicalDoctor)[0][0]: "+medicalDoctorTransactionsContainer.get(inputMedicalDoctor)[0][0]);

			}
			else {
/*
			  iMedicalDoctorTransactionsRowCount = medicalDoctorTransactionsCountContainer.get(inputMedicalDoctor);
			  iMedicalDoctorTransactionsRowCount++; 
*/
			  
			  //note: compile error using this technique
			  //medicalDoctorTransactionsCountContainer.get(inputMedicalDoctor)++;	

			int currentCount =medicalDoctorTransactionsCountContainer.get(inputMedicalDoctor)+1;


System.out.println("medicalDoctorTransactionsCountContainer.get(inputMedicalDoctor): "+medicalDoctorTransactionsCountContainer.get(inputMedicalDoctor));


/*
			  medicalDoctorTransactionsContainer.get(inputMedicalDoctor)[iMedicalDoctorTransactionsRowCount]=inputColumns;	
*/


			  medicalDoctorTransactionsContainer.get(inputMedicalDoctor)[medicalDoctorTransactionsCountContainer.get(inputMedicalDoctor)]=inputColumns;	

			medicalDoctorTransactionsCountContainer.put(inputMedicalDoctor,currentCount);//+1);


/*
System.out.println("inputMedicalDoctor: "+inputMedicalDoctor);
System.out.println("inputColumns[0]: "+inputColumns[0]);
System.out.println("iMedicalDoctorTransactionsRowCount: "+iMedicalDoctorTransactionsRowCount);
*/
