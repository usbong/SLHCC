...
REM Notes: 
REM 1) SMS body value using JSON format = OK
REM 2) Updated SMS body value from JSON format != OK with HTC 
REM Example: [PT Treatment,Total:1,CashTotalFee:0,CashTotalNetFee:0,HMOTotalFee:1100,HMOTotalNetFee:606.38]
REM  
REM +verified: with Samsung Galaxy Core2 Duos to successfully auto-write SMS body value in textbox
REM -reverify: with HTC Wildfire (year 2012) Android why SMS body value is blank
...
rem cd .. REM change directory to the location of the batch file
