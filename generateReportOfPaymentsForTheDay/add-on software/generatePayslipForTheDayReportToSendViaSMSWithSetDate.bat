...
REM @last updated: 20211205; (from 20210703)
...
REM set sSetDate=6/14/2021

REM added by Mike, 20211205
REM reminder#1: with sSetDate, no additional zero for numbers <10
REM reminder#2: with sSetDateISOFormat, add zero for numbers <10
REM TO-DO: -add: auto-correct inputs
set sSetDate=12/2/2021

REM set sSetDateISOFormat=2021-06-14
set sSetDateISOFormat=2021-12-02
set myYear=2021
rem add * to due to space between month and year
REM set sMonthYear=June"*"2021
set sMonthYear=December"*"2021
