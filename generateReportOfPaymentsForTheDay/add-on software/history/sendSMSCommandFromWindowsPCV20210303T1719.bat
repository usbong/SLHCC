...
rem note: no need to add quotation marks;
set myDate=2021-03-01
echo %myDate%
...
for /f "delims=" %%V in ('type "D:\Usbong\SLHCC\Reports\add-on software\output\smsReport%myDate%.txt"') do @set sSMSBodyValue=%%V
