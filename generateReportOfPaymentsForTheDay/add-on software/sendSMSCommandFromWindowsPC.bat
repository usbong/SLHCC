...
rem for /f "delims=" %%V in ('type "D:\%sYearToday%\add-on software\generatePayslipForTheDay\output\smsReport2021-03-22.txt"') do @set sSMSBodyValue=%%V
