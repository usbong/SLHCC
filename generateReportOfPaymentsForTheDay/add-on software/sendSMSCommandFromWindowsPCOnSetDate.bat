...
REM 1) set: sYearToday value to the correct SMS Report date 
REM 2) set: myDate value to the correct SMS Report date
REM
REM References:
...
rem added by Mike, 20210228; edited by Mike, 20210530
rem set sYearToday=%date:~10,4%
set sYearToday="2021"
echo %sYearToday%

rem added by Mike, 20201002; edited by Mike, 20210530
rem set myDate=%date:~10,4%-%date:~4,2%-%date:~7,2%
rem set myDate="2020-10-01"
rem set myDate="2021-01-04"
set myDate="2021-05-29"
echo %myDate%
