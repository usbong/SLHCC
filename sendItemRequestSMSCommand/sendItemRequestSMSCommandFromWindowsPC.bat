...
REM
REM Send Short Messaging Service (SMS) message with Item Request from Windows Personal Computer (PC)
REM
REM @company: USBONG SOCIAL SYSTEMS, INC. (USBONG)
REM @author: SYSON, MICHAEL B.
REM @date created: 20210228
...
rem Call generatePayslipForTheDayReportToSendViaSMS.bat
...
for /f "delims=" %%V in ('type "D:\%sYearToday%\add-on software\sendItemRequestSMSCommand\input\smsMessage.txt"') do @set sSMSBodyValue=%%V
